 ...
 *  This file was generated automatically on 05/01/17 at 11:29:50.
 *  Source file: TFA9894_N1A0_I2C_RegisterMap.xlsx
 */

#ifndef _TFA9894_TFAFIELDNAMES_H
#define _TFA9894_TFAFIELDNAMES_H

#define TFA9894_I2CVERSION    19
...
typedef enum nxpTfa9894BfEnumList {
    ...
    TFA9894_BF_BODE  = 0x0150,    /*!< Enable BOD                                         */
    ...
    TFA9894_BF_DISBLAUTOCLKSEL= 0x0470,    /*!< Disable automatic PLL reference clock selection    */
    ...
    TFA9894_BF_VDDPS = 0x1709,    /*!< IC VDDP voltage (1023*VDDP/9.5 V)                  */
    ...
    TFA9894_BF_TDMSRC0E= 0x2030,    /*!< Source 0 enable                                    */
    TFA9894_BF_TDMSRC1E= 0x2040,    /*!< Source 1 enable                                    */
    TFA9894_BF_TDMSRC2E= 0x2050,    /*!< Source 2 enable                                    */
    TFA9894_BF_TDMSRC3E= 0x2060,    /*!< Source 3 enable                                    */
    ...
    TFA9894_BF_TDMSRC2SEL= 0x2381,    /*!< TDM Source 2 data selection                        */
    TFA9894_BF_TDMSRC3SEL= 0x23a1,    /*!< TDM Source 3 data selection                        */
    TFA9894_BF_TDM72C= 0x23c0,    /*!< TFA9872/74 compatible source data control          */
    TFA9894_BF_TDMSRC0S= 0x2403,    /*!< Slot Position of source 0 data                     */
    TFA9894_BF_TDMSRC1S= 0x2443,    /*!< Slot Position of source 1 data                     */
    TFA9894_BF_TDMSRC2S= 0x2483,    /*!< Slot Position of source 2 data                     */
    TFA9894_BF_TDMSRC3S= 0x24c3,    /*!< Slot Position of source 3 data                     */
    ...
    TFA9894_BF_AMPINSEL2= 0x5781,    /*!< VAMP_OUT2 input selection                          */
...
#define TFA9894_NAMETABLE static tfaBfName_t Tfa9894DatasheetNames[]= {\
   ...
   { 0x470, "DISBLAUTOCLKSEL"},    /* Disable automatic PLL reference clock selection   , */\
   ...
   { 0x2030, "TDMSRC0E"},    /* Source 0 enable                                   , */\
   { 0x2040, "TDMSRC1E"},    /* Source 1 enable                                   , */\
   { 0x2050, "TDMSRC2E"},    /* Source 2 enable                                   , */\
   { 0x2060, "TDMSRC3E"},    /* Source 3 enable                                   , */\
   ...
   { 0x2381, "TDMSRC2SEL"},    /* TDM Source 2 data selection                       , */\
   { 0x23a1, "TDMSRC3SEL"},    /* TDM Source 3 data selection                       , */\
   { 0x23c0, "TDM72C"},    /* TFA9872/74 compatible source data control         , */\
   { 0x2403, "TDMSRC0S"},    /* Slot Position of source 0 data                    , */\
   { 0x2443, "TDMSRC1S"},    /* Slot Position of source 1 data                    , */\
   { 0x2483, "TDMSRC2S"},    /* Slot Position of source 2 data                    , */\
   { 0x24c3, "TDMSRC3S"},    /* Slot Position of source 3 data                    , */\
   ...
   { 0x5781, "AMPINSEL2"},    /* VAMP_OUT2 input selection                         , */\
...
#define TFA9894_BITNAMETABLE static tfaBfName_t Tfa9894BitNames[]= {\
   ...
   { 0x470, "disable_auto_sel_refclk"},    /* Disable automatic PLL reference clock selection   , */\
   ...
   { 0x23c0, "tdm_tfa9872_compatible"},    /* TFA9872/74 compatible source data control         , */\
   ...
   { 0x5965, "hold_time"},    /* Low noise gain mode hold time before low audio is reckoned to be low audio, */\
   ...
   { 0x5b65, "lpm1_hold_time"},    /* Low power mode1 detector ctrl hold time before low audio is reckoned to be low audio, */\
