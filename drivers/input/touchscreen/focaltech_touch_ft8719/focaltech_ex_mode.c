...
static ssize_t touch_charger_mode_proc_write(struct file *filp, const char *buff, size_t len, loff_t *off)
{
    int ret;
...
static struct file_operations touch_charger_mode_proc_ops = {
    .write = touch_charger_mode_proc_write,
};
