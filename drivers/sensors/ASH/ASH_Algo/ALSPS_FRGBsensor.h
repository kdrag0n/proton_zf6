...
/**
 * FRGB_LOG_THRESHOLD : We print FRGB sensor log 
 * when the current FRGB raw data change over 100 count from the last raw data.
 */
#define FRGB_LOG_THRESHOLD					(100)
...
/**
 * @FRGB_POLLING_TIME : Define the Front RGB polling time.
 */
#define FRGB_POLLING_FIRST_RAW	(10)
#define FRGB_POLLING_TIME		(500)
